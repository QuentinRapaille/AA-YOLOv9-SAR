...
from models.yolo import ClassificationModel, Detect, DDetect, DDetect_AA, DualDetect, DualDDetect, DetectionModel, SegmentationModel
...
def run(
    ...
    for k, m in model.named_modules():
        if isinstance(m, (Detect, DDetect, DDetect_AA, DualDetect, DualDDetect)):
            m.inplace = inplace
            m.dynamic = dynamic
            m.export = True
